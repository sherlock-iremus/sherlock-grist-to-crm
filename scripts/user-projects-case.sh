...
case "$1" in
    "aam")
        python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
            ...
            --output_ttl $OUTPUT_TTL_ROOT/grist/projects/aam.ttl \
    ...
    "euterpe-oeuvres")
        python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
            ...
            --output_ttl $OUTPUT_TTL_ROOT/grist/projects/euterpe-oeuvres.ttl \
    ...
    "euterpe-personnes")
        python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
            ...
            --output_ttl $OUTPUT_TTL_ROOT/grist/projects/euterpe-personnes.ttl \
    ...
    "mg-livraisons")
        python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
            ...
            --output_ttl $OUTPUT_TTL_ROOT/grist/projects/mg-livraisons.ttl \
    ...
    "refar-personnes")
        python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
            ...
            --output_ttl $OUTPUT_TTL_ROOT/grist/projects/refar-personnes.ttl \
