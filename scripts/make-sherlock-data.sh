...
rm -rf $OUTPUT_TTL_ROOT/grist/sherlock
mkdir -p $OUTPUT_TTL_ROOT/grist/sherlock
...
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    ...
    --output_ttl $OUTPUT_TTL_ROOT/SHERLOCK-PERSONS.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E21_Person \

# Projets
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_PROJECTS \
    --output_ttl $OUTPUT_TTL_ROOT/grist/sherlock/SHERLOCK-PROJECTS.ttl \
...
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    ...
    --output_ttl $OUTPUT_TTL_ROOT/grist/sherlock/SHERLOCK-COLLECTIONS.ttl \
    --rdf_type http://data-iremus.huma-num.fr/ns/sherlock#Collection \

# Fichiers des projets
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_PROJECTS_FILES \
    --output_ttl $OUTPUT_TTL_ROOT/grist/sherlock/SHERLOCK-PROJECTS-FILES.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E31_Document \

# E35 E55
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_E35_E55 \
    --output_ttl $OUTPUT_TTL_ROOT/sherlock/SHERLOCK-E35-E55.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E55_Type \
    
# E41 E55
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_E41_E55 \
    --output_ttl $OUTPUT_TTL_ROOT/sherlock/SHERLOCK-E41-E55.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E55_Type \
    
# E42 E55
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_E42_E55 \
    --output_ttl $OUTPUT_TTL_ROOT/sherlock/SHERLOCK-E42-E55.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E55_Type \
    
# P3 E55
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    --grist_table_id SHERLOCK_P3_E55 \
    --output_ttl $OUTPUT_TTL_ROOT/grist/sherlock/SHERLOCK-P3-E55.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E55_Type \
...
python3 -m sherlock_grist_to_crm.grist-to-crm $common_args \
    ...
    --output_ttl $OUTPUT_TTL_ROOT/grist/sherlock/SHERLOCK-E13-E55.ttl \
    --rdf_type http://www.cidoc-crm.org/cidoc-crm/E55_Type \